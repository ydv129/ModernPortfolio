...
/* Img */
const proyectsImg = require.context('../../img', false, /\.(png|jpe?g|svg|webp)$/i);
                    ...
                    <div className="pw-content">
                        ...
                        <div className="eins-modal-text">
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <a href="https://github.com/ydv129" target="_blank">https://github.com/ydv129</a>
                            </div>
                        ...
                        <div className="eins-modal-text">
                            ...
                            <p>
                                <FormattedMessage
                                    ...
                                    defaultMessage="A chess game that allowed me to play against another user."
                                />
                            </p>
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <a href="https://github.com/ydv129" target="_blank">https://github.com/ydv129</a>
