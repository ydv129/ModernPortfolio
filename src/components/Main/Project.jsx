...
/* Img */
const proyectImg = require.context('../../img', false, /\.(png|jpe?g|svg|webp)$/i);
                ...
                >
                    <SwiperSlide className='caja'>
                        ...
                        <div className="content">
                            ...
                            <a href="https://github.com/ydv129" className="custom-btn btn" target="_blank" rel="noopener noreferrer"><span>Demo</span></a>
                            <a href="https://github.com/ydv129" className="custom-btn btn-codigo" target="_blank" rel="noopener noreferrer">Repository</a>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className='caja'>
                        <img
